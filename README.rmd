...
knitr::kable(
  tibble::tibble(
    ...
    link = paste0("https://curso-r.github.io/intro-ml-mestre/", exemplo)
  ) %>%
    mutate(
...
knitr::kable(
  tibble::tibble(
    ...
    link = paste0("https://curso-r.github.io/202006-intro-ml/", scripts_feitos_em_aula)
  ) %>%
    mutate(
...
knitr::kable(
  tibble::tibble(
    ...
    link = paste0("https://curso-r.github.io/intro-ml-mestre/", exercicio)
  ) %>%
    mutate(
...
knitr::kable(
  tibble::tibble(
    gabarito = CursoR:::list_github_files("intro-ml-mestre", "gabaritos/", "\\.R"),
    link = paste0("https://curso-r.github.io/intro-ml-mestre/", gabarito)
  ) %>%
    mutate(
...
- [Feature Engineering and Selection: A Practical Approach for Predictive Models (Khun, Kjell)](http://www.feat.engineering/)
